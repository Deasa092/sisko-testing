...
WebUI.setText(findTestObject('Page_Login  sistemtoko.com/input_Password_password'), '')
...
WebUI.verifyElementVisibleInViewport(findTestObject('Page_Login  sistemtoko.com/Failed-Login-Message'), 0)
