...
WebUI.setText(findTestObject('Page_Register  sistemtoko.com/input_Kode Voucher ( bila ada )_code_voucher'), 'vasdwe32')

WebUI.verifyElementVisible(findTestObject('Page_Register  sistemtoko.com/message_Voucher code is invalid'), FailureHandling.STOP_ON_FAILURE)
